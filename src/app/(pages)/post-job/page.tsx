...
export default function PostJob() {
  ...
  return (
    <ProtectedRoute allowedRoles={["main_contractor"]}>
            ...
            <Container maxWidth="md">
              <Box component="form" onSubmit={handleSubmit}>
                ...
                <Card>
                  ...
                  <CardContent>
                    <FormControl fullWidth variant="outlined">
                      ...
                      <Select labelId="job-type-label" value={jobType} onChange={(e) => setJobType(e.target.value)} label="Select Job Type">
                        {jobTypes.map((type) => (
                ...
                <Card>
                  ...
                  <CardContent>
                    <FormControlLabel
                      control={<Checkbox checked={isUrgent} onChange={(e) => setIsUrgent(e.target.checked)} color="primary" />}
                      label={
                        <Typography
                          variant="body1"
                    ...
                    {isUrgent && (
                      <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
                        Marking a job as urgent will highlight it in the job listings and notify potential candidates immediately.
                      </Typography>
                    )}
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
                      ...
                      <Typography variant="body2" sx={{ fontWeight: "medium" }}>
                        {coordinates ? "Selected location:" : "Click on the map to select a location or search for an address"}
                      </Typography>
                    </Box>
                      ...
                      <Card key={index} sx={{ mb: 3, boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>
                        ...
                        <CardContent>
                          <Grid container spacing={3}>
                            ...
                            <Grid item xs={12}>
                              <FormLabel required sx={{ display: "block", mb: 1 }}>
                                Number of {service.type === "Other" ? service.customType || "Workers" : service.type + "s"} Required
                              </FormLabel>
                              <TextField
                                required
                                fullWidth
