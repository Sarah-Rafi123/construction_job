          ...
          <div>
            ...
            <form className="flex w-auto">
              <input
                ...
                className="px-4 py-2 bg-gray-800 text-white rounded-l-lg focus:outline-none focus:ring-2 min-w-2 focus:ring-[#F5A623] border border-gray-700 flex-grow"
              />
              <button
                type="submit"
                className="px-4 py-2 bg-[#F5A623] text-white font-medium rounded-r-lg hover:bg-[#E09613] cursor-pointer transition-colors"
              >
                Subscribe
              </button>
            </form>
